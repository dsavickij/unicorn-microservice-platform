...
public class MultiplicationGrpcService : Unicorn.Core.Development.Server.SDK.Services.gRPC.Protos.MultiplicationGrpcService.MultiplicationGrpcServiceBase
{
