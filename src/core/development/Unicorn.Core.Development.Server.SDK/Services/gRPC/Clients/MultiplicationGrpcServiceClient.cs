...
public interface IMultiplicationGrpcServiceClient
{
    ...
    Task<int> GetMultiplicationSequenceSumAsync(IAsyncEnumerable<(int, int)> producer, CancellationToken token);
}
...
public class MultiplicationGrpcServiceClient : BaseGrpcClient, IMultiplicationGrpcServiceClient
{
    ...
    public async Task<int> GetMultiplicationSequenceSumAsync(IAsyncEnumerable<(int, int)> provider, CancellationToken token)
    {
