...
public static class MessageBrokerConfigurationExtensions
{
    ...
    {
        // TODO: check if initiliazation of HostSettings for RabbitMq and AzureSB can be unified, fix cfg for Rabbit
        // var settings = new MassTransit.RabbitMqTransport.Configuration.RabbitMqHost()
        // {
        //     
        // }
        // {
